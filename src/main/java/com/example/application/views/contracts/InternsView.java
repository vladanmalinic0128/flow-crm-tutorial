...
public class InternsView extends FormLayout {
    ...
    public InternsView(CollaboratorsXlsxService collaboratorsXlsxService) {
        ...
        Button contracts = new Button("Ugovori za interne saradnike", downloadIcon);
        ...
        Button decision = new Button("Odluka za interne saradnike", downloadIcon);
    ...
    private Upload configureFileUpload() {
        ...
        upload.addSucceededListener(event -> {
            ...
            collaboratorsXlsxService.updateCollaboratorsThroughXlsxFile(inputStream, false);
        });
    ...
    private VerticalLayout createDialogLayoutForContracts(Dialog dialog) {
        ...
        String fileTitle = "interni_saradnici_ugovori" + "_" + System.currentTimeMillis() + ".pdf";
        ...
        Anchor saveButtonAnchor = new Anchor(new StreamResource(fileTitle, () -> {
            ...
            try {
                stringPath = collaboratorsXlsxService.generateContracts(fileTitle, scripts.getValue(), false);
            } catch (IOException e) {
    ...
    private VerticalLayout createDialogLayoutForDecision(Dialog dialog) {
        ...
        String fileTitle = "interni_saradnici_odluka" + "_" + System.currentTimeMillis() + ".docx";
        ...
        Anchor saveButtonAnchor = new Anchor(new StreamResource(fileTitle, () -> {
            ...
            String stringPath = null;
            try {
                stringPath = collaboratorsXlsxService.generateDecision(fileTitle, scripts.getValue(), false);
            } catch (IOException e) {
                throw new RuntimeException(e);
