...
//
    ...
    private Dialog createDialog(PoliticalOrganizationEntity entity) {
    ...
    private VerticalLayout createDialogLayout(Dialog dialog, PoliticalOrganizationEntity entity) {
        ...
        Anchor saveButtonAnchor = new Anchor(new StreamResource(fileTitle, () -> {
            ...
            String stringPath = councelXlsxService.generateCouncelsByPoliticalOrganization(entity, fileTitle, scripts.getValue());
            dialog.close();
            if(stringPath != null)
